module.exports = {
	init: async function (client) {
		...
		await client.query('CREATE TABLE userinfo (username varchar(128) PRIMARY KEY NOT NULL REFERENCES users(username), first_name varchar(256), last_name varchar(256), address varchar(512), city varchar(256), zip_code varchar(128), state varchar(256), country varchar(256), email varchar(512), phone_number varchar(32), language varchar(100))')
